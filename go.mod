module github.com/aws-controllers-k8s/rolesanywhere-controller

go 1.26.1

require (
	github.com/aws-controllers-k8s/acmpca-controller v1.4.1
	github.com/aws-controllers-k8s/iam-controller v1.8.1
