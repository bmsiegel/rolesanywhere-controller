...
// +kubebuilder:rbac:groups=rolesanywhere.services.k8s.aws,resources=trustanchors,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=rolesanywhere.services.k8s.aws,resources=trustanchors/status,verbs=get;update;patch

var lateInitializeFieldNames = []string{"Enabled"}
...
func (rm *resourceManager) lateInitializeFromReadOneOutput(
	...
	if observedKo.Spec.Enabled != nil && latestKo.Spec.Enabled == nil {
		latestKo.Spec.Enabled = observedKo.Spec.Enabled
	}
