...
const (
	FinalizerString = "finalizers.rolesanywhere.services.k8s.aws/TrustAnchor"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("trustanchors")
	GroupKind            = metav1.GroupKind{
		Group: "rolesanywhere.services.k8s.aws",
		Kind:  "TrustAnchor",
	}
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.TrustAnchor{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.TrustAnchor),
	}
}
