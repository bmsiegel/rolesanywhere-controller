...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Status.TrustAnchorID = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	f0, ok := fields["trustAnchorID"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: trustAnchorID"))
	}
	r.ko.Status.TrustAnchorID = &f0
