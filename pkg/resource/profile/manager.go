...
// +kubebuilder:rbac:groups=rolesanywhere.services.k8s.aws,resources=profiles,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=rolesanywhere.services.k8s.aws,resources=profiles/status,verbs=get;update;patch
