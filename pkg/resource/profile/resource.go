...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Status.ProfileID = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	f0, ok := fields["profileID"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: profileID"))
	}
	r.ko.Status.ProfileID = &f0
