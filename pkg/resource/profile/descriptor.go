...
const (
	FinalizerString = "finalizers.rolesanywhere.services.k8s.aws/Profile"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("profiles")
