...
import (
	...
	svctypes "github.com/aws-controllers-k8s/rolesanywhere-controller/apis/v1alpha1"
	svcresource "github.com/aws-controllers-k8s/rolesanywhere-controller/pkg/resource"

	_ "github.com/aws-controllers-k8s/rolesanywhere-controller/pkg/resource/profile"
	_ "github.com/aws-controllers-k8s/rolesanywhere-controller/pkg/resource/trust_anchor"

	"github.com/aws-controllers-k8s/rolesanywhere-controller/pkg/version"
)

var (
	awsServiceAPIGroup = "rolesanywhere.services.k8s.aws"
	awsServiceAlias    = "rolesanywhere"
